...
class NPUModelRunner(LoRAModelRunnerMixin):
    ...
    def _process_reqs(
        ...
        intermediate_tensors: Optional[IntermediateTensors] = None,
               ...
               torch.Tensor, int, torch.Tensor, torch.Tensor, Optional[set[str]], Optional[set[str]]]:
        # Check input valid
        total_num_scheduled_tokens = scheduler_output.total_num_scheduled_tokens
        assert total_num_scheduled_tokens > 0
        num_reqs = self.input_batch.num_reqs
        ...
        return (attn_metadata, hidden_states, spec_decode_metadata, positions,
                total_num_scheduled_tokens, sample_indices, aux_hidden_states, finished_sending, finished_recving)
    ...
    def execute_model(
        ...
        with ProfileExecuteDuration().capture_async(
            ...
            finished_sending, finished_recving) = (self._process_reqs(scheduler_output, intermediate_tensors))
